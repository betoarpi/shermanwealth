...
add_action('graphql_register_types', function(){
  register_graphql_mutation('createSubmission', [
    'inputFields' => [
      ...
      'userReferrer' => [
        'type' => 'String',
        'description' => 'User Referrer'
      ],
    ],
    'outputFields' => [
      'success' => [
        'type' => 'Boolean',
        'description' => 'Wether or not data was stored successfully',
    ...
    'mutateAndGetPayload' => function($input, $context, $info) {
      ...
      $errors = [];
      $acceptable_fields = [
        'userName' => 'field_5df2acbd79e9f',
        'userEmail' => 'field_5df2acd479ea0',
        'userMessage' => 'field_5df2ace679ea1',
        'userReferrer' => 'field_5df2acfb79ea2',
      ];
      ...
      $form_submission = wp_insert_post([
        ...
        'post_title' => $sanitized_data['userName'] . ' sent a message.',
      ], true);
